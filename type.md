...
Official TypeScript/JavaScript client for the Hindsight API. Supports **Node.js** and **Deno**.Installation[​](#installation)Node.js[​](#nodejs)```codeBlockLines_AclH
npm install @vectorize-io/hindsight-client

```

Deno[​](#deno)No installation needed — import directly via the `npm:` specifier:```codeBlockLines_AclH
import { HindsightClient } from "npm:@vectorize-io/hindsight-client";

```

Quick Start[​](#quick-start)```codeBlockLines_AclH
...
Client Initialization[​](#client-initialization)```codeBlockLines_AclH
import { HindsightClient } from '@vectorize-io/hindsight-client';
...
Core Operations[​](#core-operations)Retain (Store Memory)[​](#retain-store-memory)```codeBlockLines_AclH
// Simple
await client.retain('my-bank', 'Alice works at Google');
...
Retain Batch[​](#retain-batch)```codeBlockLines_AclH
...
Recall (Search)[​](#recall-search)```codeBlockLines_AclH
...
Reflect (Generate Response)[​](#reflect-generate-response)```codeBlockLines_AclH
...
Bank Management[​](#bank-management)Create Bank[​](#create-bank)```codeBlockLines_AclH
...
List Memories[​](#list-memories)```codeBlockLines_AclH
